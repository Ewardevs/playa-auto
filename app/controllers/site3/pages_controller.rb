module Site3
  ...
  class PagesController < BaseController
    def about
      ...
      breadcrumb t("site3.nav.about")

      seo.title       = site_content.about_title.presence || t("site3.about.title_fallback")
      seo.description = site_content.about_description.presence ||
                        t("site3.about.seo.description", company: current_setting.company_name)
    ...
    def faqs
      ...
      breadcrumb t("site3.nav.faqs")

      seo.title       = t("site3.faqs.title")
      seo.description = t("site3.faqs.seo.description", company: current_setting.company_name)
    ...
    def contact
      ...
      breadcrumb t("site3.nav.contact")

      seo.title       = t("site3.contact.title")
      seo.description = t("site3.contact.seo.description",
