module Site3
  # Base de la tercera web pública.
  #
  # Igual que Site2: independiente en la presentación, idéntica en el dominio.
  # No conoce a Site:: ni a Site2:: — lo único que comparten los tres sitios son
  # los modelos, los query objects, los services y los componentes UI::.
  class BaseController < ApplicationController
    ...
    # Mismos nombres que en los otros dos a propósito: ApplicationComponent
    ...
    # Falla cerrado: solo un `false` explícito saca a Site3 del modo evaluación.
    ...
    def preview? = Rails.configuration.x.site3.preview != false
