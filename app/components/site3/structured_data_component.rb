...
module Site3
  ...
  # aparece acá tiene que apuntar a /v3: un grafo que declarara las direcciones
  ...
  class StructuredDataComponent < ApplicationComponent
    ...
    def root_url = helpers.site3_root_url

    def vehicle_url(record) = helpers.site3_vehicle_url(record)
    ...
    def breadcrumb_graph
      ...
      items = [ [ t("site3.nav.home"), root_url ] ] + breadcrumbs
