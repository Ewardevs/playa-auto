...
module Site2
  ...
  # aparece acá tiene que apuntar a /v2: un grafo que declarara las direcciones
  ...
  class StructuredDataComponent < ApplicationComponent
    ...
    def root_url = helpers.site2_root_url

    def vehicle_url(record) = helpers.site2_vehicle_url(record)
    ...
    def breadcrumb_graph
      ...
      items = [ [ t("site2.nav.home"), root_url ] ] + breadcrumbs
