...
# Site copy, so it follows the same rule as FAQs and the rest of the content.
class DifferentialPolicy < ApplicationPolicy
  ...
  def permitted_attributes = %i[title description icon position active]
